...
const AssistantMessage: FC = () => {
  return (
    <MessagePrimitive.Root className="grid grid-cols-[auto_auto_1fr] grid-rows-[auto_1fr] relative w-full max-w-[var(--thread-max-width)] py-4 animate-slide-up">
      {/* AI avatar — ASHURA logo */}
      <div
        className="col-start-1 row-start-1 mt-1.5 mr-3 flex size-7 shrink-0 items-center justify-center rounded-full overflow-hidden"
        style={{
          border: "1px solid rgba(200,0,0,0.4)",
          boxShadow: "0 0 10px rgba(200,0,0,0.4)",
        }}
      >
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img
          ...
          onError={(e) => {
            ...
            el.parentElement!.style.background = "linear-gradient(135deg,#4a0000,#8b0000)";
            el.parentElement!.textContent = "A";
          }}
        />
      </div>
